...
function init() {
    ...
    setInterval(function () {
        ...
        if ( // 1st box: left half of ocean
            (left_coord < 0.09*BG_section.clientWidth && top_coord < 0.38*BG_section.clientHeight && top_coord > 0.26*BG_section.clientHeight)
            || // 2nd box: right half of ocean before mountain
            (left_coord > 0.09*BG_section.clientWidth && left_coord < 0.22*BG_section.clientWidth && top_coord < 0.43*BG_section.clientHeight && top_coord > 0.26*BG_section.clientHeight)
            || // 3rd box: corner next to mountaintop
            (left_coord > 0.22*BG_section.clientWidth && left_coord < 0.25*BG_section.clientWidth && top_coord < 0.33*BG_section.clientHeight && top_coord > 0.26*BG_section.clientHeight)
            || // 3.5a1 box: very top ocean strip (wide)
            (left_coord > 0.22*BG_section.clientWidth && left_coord < 0.30*BG_section.clientWidth && top_coord < 0.29*BG_section.clientHeight && top_coord >= 0.26*BG_section.clientHeight)
            || // 3.5a2 box: ocean strip below top (narrower to avoid peak)
            (left_coord > 0.22*BG_section.clientWidth && left_coord < 0.26*BG_section.clientWidth && top_coord < 0.33*BG_section.clientHeight && top_coord >= 0.29*BG_section.clientHeight)
            || // 3.5b box: lower ocean alongside mountain peak (narrower)
            (left_coord > 0.22*BG_section.clientWidth && left_coord < 0.26*BG_section.clientWidth && top_coord < 0.41*BG_section.clientHeight && top_coord >= 0.33*BG_section.clientHeight)
            || // 4th box: fjord entrance
            (left_coord > 0.38*BG_section.clientWidth && left_coord < 0.47*BG_section.clientWidth && top_coord < 0.48*BG_section.clientHeight && top_coord > 0.38*BG_section.clientHeight)
            || // 5th box: fjord middle
            (left_coord > 0.41*BG_section.clientWidth && left_coord < 0.49*BG_section.clientWidth && top_coord < 0.56*BG_section.clientHeight && top_coord >= 0.48*BG_section.clientHeight)
            || // 6th box: fjord middle bend (wide)
            (left_coord > 0.40*BG_section.clientWidth && left_coord < 0.52*BG_section.clientWidth && top_coord < 0.63*BG_section.clientHeight && top_coord >= 0.56*BG_section.clientHeight)
            || // 7a box: fjord lower-upper
            (left_coord > 0.39*BG_section.clientWidth && left_coord < 0.49*BG_section.clientWidth && top_coord < 0.67*BG_section.clientHeight && top_coord >= 0.63*BG_section.clientHeight)
            || // 7b box: fjord lower-middle
            (left_coord > 0.39*BG_section.clientWidth && left_coord < 0.47*BG_section.clientWidth && top_coord < 0.70*BG_section.clientHeight && top_coord >= 0.67*BG_section.clientHeight)
            || // 7c box: fjord lower-bottom
            (left_coord > 0.38*BG_section.clientWidth && left_coord < 0.45*BG_section.clientWidth && top_coord < 0.73*BG_section.clientHeight && top_coord >= 0.70*BG_section.clientHeight)
            || // 8th box: flow from mountain into fjord
            (left_coord > 0.35*BG_section.clientWidth && left_coord <= 0.43*BG_section.clientWidth && top_coord < 0.76*BG_section.clientHeight && top_coord >= 0.73*BG_section.clientHeight)
            || // 9th box: crater lake
            (left_coord > 0.69*BG_section.clientWidth && left_coord < 0.8*BG_section.clientWidth && top_coord < 1.01*BG_section.clientHeight && top_coord > 0.78*BG_section.clientHeight)
